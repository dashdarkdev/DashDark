...
"        Copyright &copy; YYYY The DashDark developers\n"
"        Copyright &copy; 2012-YYYY The Peercoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About DashDark", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>DashDark</b> version", 0));
